    ...
    extend: {
      ...
      colors: {
        ...
        planet: {
          ...
          red: "hsl(var(--planet-red))",
          blue: "hsl(var(--planet-blue))",
          gold: "hsl(var(--planet-gold))",
        },
        space: {
      ...
      backgroundImage: {
        ...
        'gradient-nebula': 'linear-gradient(135deg, hsl(280 60% 15%) 0%, hsl(250 40% 8%) 50%, hsl(220 50% 10%) 100%)',
      },
    },
  },
